...
import { ACTIVE_QUIZ, LOGIN, SLIDER_DETAILS, SLIDER_LIST, TOP_WINNERS, TOP_WINNERS_CONSISTENT, TOP_WINNERS_PERFORMANCE } from "../common/webUtils";
...
export default function PerformanceResultsScreen({ navigation }) {
    ...
    const renderTopperItem = ({ item, index }) => (
        <Animatable.View
            ...
            duration={1000}
            delay={index * 300} style={{ flexDirection: "row", backgroundColor: colors.themeYellowColor, height: 100, marginHorizontal: 40, borderRadius: 24, justifyContent: "center", }}>
                    ...
                    <View style={{ backgroundColor: colors.themeColor, borderRadius: 360, height: 450, alignItems: "center", top: -170, alignSelf: "center" }}>
                        ...
                        <View style={{ backgroundColor: colors.white, borderRadius: 360, width: 435, height: 435, alignItems: "center", justifyContent: "center" }}>
                            <View style={{ backgroundColor: colors.themeColor, borderRadius: 11, paddingHorizontal: SW(13), paddingVertical: SH(7), marginTop: 100 }}>
                                <Text style={{ color: colors.white, fontSize: SF(30), fontFamily: getPopBoldFont() }}>{"Performance"}</Text>
                            </View>
